...
<div style="white-space: nowrap; display: flex; flex-wrap: nowrap; gap: 5px;">
  <a href="https://github.com/search?q=repo%3AMiaowCham%2FCodex_Limit_Widget++language%3AC%23&type=code"><img src="https://img.shields.io/badge/Node.js-22%2B-339933?logo=nodedotjs&logoColor=white" alt="Node.js 22+" style="display: inline-block;"></a>
  <a href="https://github.com/MiaowCham/ncm-cli/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg" alt="License: MIT" style="display: inline-block;"></a>
  <a href="https://github.com/MiaowCham/ncm-cli/commits/main"><img src="https://img.shields.io/github/last-commit/MiaowCham/ncm-cli" alt="GitHub last commit" style="display: inline-block;"></a>
</div>  
...
使用 `/image` 可以交互选择协议。`ansi` 保留原始尺寸的 24-bit 真彩字符画；低性能终端可单独选择 `ansi256`，使用最大 32×12 的 256 色紧凑字符画。此设置不影响登录二维码，二维码始终优先使用字符画。
